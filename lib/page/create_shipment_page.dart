...
class _CreateShipmentPageState extends State<CreateShipmentPage> {
  ...
  // --- MODIFIED --- (แก้ไข Widget นี้ทั้งหมด)
    ...
    return Column(
      ...
      children: [
        InkWell(
          ...
          child: Container(
            width: double.infinity,
            // --- MODIFIED --- (ระยะขอบล่างเอาออก ให้ไปอยู่
            // ที่ AnimatedContainer แทน ถ้าไม่ถูกเลือก)
            margin: isSelected
        ...
        // 2. ส่วนของแผนที่ ที่จะแสดง/ซ่อน
        // --- ADDED ---
        AnimatedContainer(
          // ใช้ AnimatedContainer เพื่อให้ค่อยๆ เปิด/ปิด
  ...
  // --- ADDED ---
  // ฟังก์ชันสำหรับสร้าง Widget แผนที่
